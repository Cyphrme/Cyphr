...
software (or substantial derivatives) as a hosted/managed service. Payments fund
ongoing development of this project and grants to other open-source initiatives
...
3. Any institution (university, college, foundation, or similar entity) with an
   endowment (or total investable assets dedicated to its support) of **$500
...
5. Any government (federal, state, provincial, local, or national) or
   ...
   enterprises, public universities under government control, sovereign wealth
...
(including its affiliates and subsidiaries), then use of this software by that
entity (or on its behalf) requires a paid commercial license from the copyright
holder.

Use by individuals or entities below this threshold remains governed by the free
...
cryptographic keys—to the public, or to more than 100 individuals or entities,
must obtain a separate paid commercial license from the copyright holder,
regardless of any other terms, thresholds, or exceptions in this license.

This requirement applies irrespective of whether the key management is provided
as a standalone service, integrated into other software, offered on a
commercial, freemium, open-source, or internal basis exceeding the scale
threshold.

Use of this software in connection with such key management activities without
...
For commercial licensing inquiries: buy@cyphr.me
...
1. **Ownership/Affiliation Threshold**  
   The entity (or any affiliate) is a Designated Entity, OR any Designated Individual/Entity holds >2% direct/indirect equity, voting rights, or beneficial ownership.

2. **Hosted / Managed Service**  
   You offer the software (or a substantial derivative/modification) to third parties over a network as a service, SaaS, API, managed hosting, key management service, authentication backend, or similar—where users access functionality without running their own unmodified instance.  
   This includes cloud-hosted offerings, freemium platforms, or services exceeding 100 distinct paying/enterprise users.

3. **Large-Scale Use** (fallback)  
   Your entity exceeds the size thresholds in Designated Entities §3 and uses the software in production for internal or customer-facing purposes without qualifying under the free tier.
...
This license is inspired by the Apache License 2.0 and is intended to comply
with the Open Source Initiative (OSI) definition of open source software. It
grants permissions to use, reproduce, modify, distribute, and sublicense the
software freely, subject to the conditions below. The software is provided "as
...
- Sublicense the software or derivatives under this License or compatible open
  source licenses.

You must retain this License, copyright notices, and any NOTICE file in all
...
lifecycle management of cryptographic keys—to the public or to more than 100
individuals or entities, then you must either:

1. **Open Source Requirement**: Release all source code related to the key
   management service (including any modifications, integrations, or extensions
   to this software) under this License or a compatible OSI-approved open source
   license. Additionally, make all user-generated data associated with the
   service (e.g., comments, metadata, or other non-personal user content)
   publicly accessible via a documented API for download, in a machine-readable
   format, without restrictions on use or redistribution (subject to applicable
   privacy laws). This requirement applies irrespective of whether the service
   is standalone, integrated, commercial, freemium, or internal (exceeding the
   scale threshold).

   OR

2. **Paid Commercial License**: Obtain a separate paid commercial license from
   the copyright holder, which waives the open source and data accessibility
   requirements above.

Fully open source projects that already release their code and data under
compatible terms are not affected by this clause and may use the software freely
