...
/-- The EON trilemma's impossibility corner (statement-v0.2 §3, Result 3's slogan:
    "offline, unexpiring, non-monotone — pick two"). A direct two-line consequence of
    ...
    `Context.inhabited`), no `sorryAx`. Per statement-v0.2 §6 item 5, writing this
    *exact* type was itself part of the mechanized content requested here
