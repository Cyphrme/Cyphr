...
Recomputed after campaign: N01-lifecycle-state (LifecycleState enum,
...
- ⚪ OOS: 8 (errored-orthogonal v1-always-false, canmutate-non-monotonic L5+, merge-_/fork-_ all unimplemented)
