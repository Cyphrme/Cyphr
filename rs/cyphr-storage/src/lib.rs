...
//! - `cyphr_index_sqlite::SqliteIndexer` (in the `cyphr-index-sqlite` crate): A persistent
//!   relational indexer backed by SQLite.
//! - [`index::memory::MemoryIndexer`]: An in-memory relational indexer for testing.
