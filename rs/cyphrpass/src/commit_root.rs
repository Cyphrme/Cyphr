...
/// A single-algorithm hasher for the Cyphrpass MALT implementation.
///
...
impl TreeHasher for CyphrpassHasher {
    type Digest = Vec<u8>;
...
pub type CommitLog = Log<CyphrpassHasher>;
